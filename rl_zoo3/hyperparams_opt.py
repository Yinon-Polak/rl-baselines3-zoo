...
def sample_ppo_params(trial: optuna.Trial) -> Dict[str, Any]:
    ...
    :return:
    """
    # batch_size = trial.suggest_categorical("batch_size", [256])  # [8, 16, 32, 64, 128, 256, 512]
    # n_steps = trial.suggest_categorical("n_steps", [8, 16])  # [8, 16, 32, 64, 128, 256, 512, 1024, 2048]
    gamma = trial.suggest_categorical("gamma", [0.95, 0.98, 0.99])
    learning_rate = trial.suggest_loguniform("learning_rate", 1e-5, 1e-4, log=True)
    ...
    gae_lambda = trial.suggest_categorical("gae_lambda", [0.8, 0.9, 0.92, 0.95])
    max_grad_norm = trial.suggest_categorical("max_grad_norm", [0.9, 1, 2, 5])
