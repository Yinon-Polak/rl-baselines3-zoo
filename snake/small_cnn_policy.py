...
class NatureSmallCNN(BaseFeaturesExtractor):
    ...
    def __init__(
        ...
        modules = [
            nn.Conv2d(n_input_channels, initial_layer_out_channels, kernel_size=kernel_size_1, stride=stride_1,
                      padding=padding_1),
            activation_func(),
            nn.Conv2d(initial_layer_out_channels, deep_layers_out_channels, kernel_size=kernel_size_2, stride=stride_2,
                      padding=padding_2),
            activation_func(),
        ]
        if kernel_size_3:
            modules.extend(
                [
                    nn.Conv2d(deep_layers_out_channels, deep_layers_out_channels, kernel_size=kernel_size_3,
